...
- [A-08][Agent A] Prompt/schema and eight structured mapper samples pass, but no LLM replay cassette directory or `GOOGLE_API_KEY` is available to validate domain accuracy on eight real LLM responses.
